...
def variables_tabla_frecuencias(num_decimales,datos):
    valor_max = max(datos)
    valor_min = min(datos)
    num_datos = len(datos)
...
def imprimir_tabla_frecuencias(num_decimales,datos):
    valor_max, valor_min, ancho_intervalo, num_datos, num_intervalos, frecuencias = variables_tabla_frecuencias(num_decimales,datos)
    print(f"N: {num_datos}")
...
def graficar_histograma(num_decimales,datos):
    valor_max, valor_min, ancho_intervalo, num_datos, num_intervalos, frecuencias = variables_tabla_frecuencias(num_decimales,datos)
...
num_decimales = 4
nombre_archivo = "data01.txt"
datos = leer_datos(num_decimales, nombre_archivo)
imprimir_tabla_frecuencias(num_decimales, datos)
graficar_histograma(num_decimales,datos)